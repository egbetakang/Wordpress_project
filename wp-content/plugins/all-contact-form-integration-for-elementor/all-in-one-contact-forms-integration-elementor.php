 ...
 */
define( 'DB_Elementor_Form', '2.9.5' );
...
function cssefe_activate_notice() {
    ...
    <div class="updated notice notice-my-class is-dismissible cssfe_notice">
        <p><?php _e( '<strong> Recommendation:</strong> Install <strong><a href=" '. $plugin_url . '">Elements CSS For Elementor</a></strong> and get <strong>Elementor Widgets</strong> more EXTENDED. <br>Now creating Sticky Header, Custom link in Image Carousel (each image), Google Maps Background Color, Sticky Inner Section is a matter of second!', 'elementoforms' ); ?></p>
    </div>
    <?php
  }
