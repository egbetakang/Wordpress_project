...
if ( ! function_exists( 'news_portal_save_page_meta' ) ) :
    ...
    function news_portal_save_page_meta( $post_id ) {
        ...
        if ( isset( $_POST['np_single_post_sidebar'] ) ) {
            ...
            $value = in_array( $_POST['np_single_post_sidebar'], array( 'default-sidebar', 'left-sidebar', 'right-sidebar', 'no-sidebar', 'no-sidebar-center' ) ) ? $_POST['np_single_post_sidebar'] : 'default-sidebar';
